...
function App({ accountAccess, syncNotice, profileExtras, media }) {
  ...
  const locked=limited && (['collection','journal'].includes(tab)||route==='#favoris'||route.startsWith('#tutoriel'));
