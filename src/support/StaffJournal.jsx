...
export default function StaffJournal({client,onExit,onSignOut}){
 ...
 return <main className="staffJournal">
  <header className="staffJournalHeader"><span className="staffJournalIcon"><ShieldCheck aria-hidden="true"/></span><div className="staffJournalHeading"><small>NAILMOODS · ESPACE INTERNE</small><h1>Journal staff</h1><p>Signalements et demandes d’aide à traiter.</p></div><button className="staffRefresh" onClick={()=>setRevision(v=>v+1)} aria-label="Actualiser le journal staff"><RefreshCw size={18}/>Actualiser</button></header>
