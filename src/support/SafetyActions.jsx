...
export function SafetyActions({client,target,onBlocked}){
 ...
 const targetLabel=target.kind==='message'?'ce message':target.kind==='journal'?'cette pose':target.kind==='inspiration'?'cette inspiration':'ce profil';
 const targetDescription=target.label?`${targetLabel} : ${target.label}`:targetLabel;
