...
export const guides = {
  home: { title: 'Bienvenue dans NailMoods', slides: [['palette', 'Tes produits, tes inspirations', 'Commence par ajouter tes vernis dans Ma collection.'], ['sparkles', 'Ta première pose', 'Ouvre Créer, choisis une idée et conserve-la dans tes favoris.']] },
  collection: { title: 'Ma collection', slides: [['package', 'Ajoute ce que tu possèdes', 'Photo, URL, scan ou saisie manuelle : choisis avec Ajouter.'], ['palette', 'Vérifie ta vraie teinte', 'Ouvre le produit pour ajuster sa couleur et son type de pose.'], ['lamp', 'Pense aussi au matériel', 'Ajoute ta lampe pour le semi-permanent, et tes stickers si tu en as.']] },
  generator: { title: 'Générer une idée', slides: [['palette', 'Tes couleurs à toi', 'Les propositions utilisent les teintes enregistrées dans ta collection.'], ['sparkles', 'Choisis ton envie', 'Mood, nombre de vernis, temps et décorations : adapte les choix.'], ['heart', 'Garde ta préférée', 'Génère une idée, ouvre sa fiche et ajoute-la aux favoris.']] },
  moodboard: { title: 'Inspirations & moodboards', slides: [['palette', 'Lis ta pose en images', 'Les ongles et les pastilles reprennent tes couleurs. La fiche indique leur répartition.'], ['sticker', 'Tes décorations', 'Choisis tes stickers dans Créer. Le motif dessiné reste schématique.'], ['heart', 'Retrouve tes idées', 'Le cœur enregistre une inspiration dans Mes inspirations favorites.']] },
