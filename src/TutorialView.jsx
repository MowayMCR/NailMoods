...
export default function TutorialView({ session, items, onAction, onOpenIdea, onCollection, onNew, onList, onJournal, journaled }) {
  ...
  const toolbar = <div className="detailToolbar"><button onClick={() => onOpenIdea(session.idea)}><ArrowLeft />L’inspiration</button><button onClick={onList}><ListChecks />Mes poses guidées</button></div>;
